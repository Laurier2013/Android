...
public class LivingRoomDatabaseHelper extends SQLiteOpenHelper {
    ...
    public static final String LIVINGITEM_NAME = "LivingItemName";
    public static final String LIVINGITEM_STATUS = "LivingItemStatus";
    ...
    public static final String CREATE_TABLE_MESSAGE = "CREATE TABLE "
            ...
            + " INTEGER PRIMARY KEY AUTOINCREMENT, " + LIVINGITEM_NAME
            + " TEXT NOT NULL, " + LIVINGITEM_STATUS + " TEXT NOT NULL );";
